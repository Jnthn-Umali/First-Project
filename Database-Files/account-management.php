...
<body style="margin: 50px; background: #f2f2f2;">
	<header>
		...
		<a class="active" href="#Account"> Accounts </a>
		<?php endif; ?>
...
<?php
	...
	if(isset($_SESSION['usertype']))
	{
		...
		echo "<a class = 'btn btn-primary btn-sm' href = 'create-account.php'>Create new account</a><br><br>";
...
function buildTable($result)
{
	if(mysqli_num_rows($result) > 0)
	{
		...
		while ($row = mysqli_fetch_array($result))
		{
			...
			echo "<td>";
			echo "<a button type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#exampleModalCenter' href = 'update-account.php?username=" . $row['username'] .  "'> Update </button>";
			
			echo "<a button type='button' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#exampleModalCenter' href='#' onclick='confirmAndDelete(\"" . $row['username'] . "\")'> Delete </button>";
			echo "</td>";
			echo "</tr>";
			echo "</tbody>";
...
?>
 ...
 <script>
        function confirmAndDelete(username) {
